...
class TravellPageBody extends StatefulWidget {
  const TravellPageBody({Key? key}) : super(key: key);

  @override
  State<TravellPageBody> createState() => _TravellPageBodyState();

}

class _TravellPageBodyState extends State<TravellPageBody> {
            ...
            child: Row(
              ...
              children: [
                ...
                Container(
                  ...
                  child: SmallText(text: "Totourise",),
                )
              ],
            ),
          ),
          //list of tourist and images
          ListView.builder(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              BigText(text: "ทุ่งดอกกระดาษ จังหวัดพิษณุโลก"),
                              SizedBox(height: Dimensions.height10,),
                              SmallText(text: "สถานที่ท่องเที่ยวทางภาคเหนือ"),
                              Row(
          ...
          Align(
            ...
            child: Container(
              ...
              child: Container(
                ...
                child:AppColumn(text: "Interesting place",),
              ),
